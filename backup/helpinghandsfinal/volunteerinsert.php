<?php
 ...
 $con = mysqli_connect('localhost', 'root', '','volunteerdb');
...
// Check for errors
		  ...
		  $sql =  mysqli_query($con,"INSERT INTO volunteer (`Firstname`, `Lastname`,  `Phoneno`,  `City`, `Email`, `Pincode`) 
...
$mail->Username = "samhithakuchibhatla@gmail.com";  // SMTP username
$mail->Password = "samkar04"; // SMTP password
$mail->From = "samhithakuchibhatla@gmail.com";
